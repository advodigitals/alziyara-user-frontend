            ...
            <div className="flex  w-full h-fit lg:flex-row flex-col container mx-auto sm:px-3 gap-y-4 pb-5 md:pb-10 pt-6">
                ...
                <div id="testimonials-section" className="flex w-full lg:flex-1 h-full justify-center items-center  ">
                    <Swiper
                        ...
                        grabCursor={true}
                        modules={[EffectCards]}
                        className="w-[200px] sm:w-[300px] h-[370px] md:h-[300px]"
                    >
                        {
                            testimonialsDataArray.map((details) => (
                                <SwiperSlide className=' flex h-full w-full bg-white rounded-[10px] px-2 sm:px-4 py-4  shadow-lg shadow-slate-600/50 cursor-grab'>
