                                ...
                                <div data-aos="fade-up" className={`flex flex-row  h-fit bg-white  rounded-[10px] items-start shadow-lg shadow-slate-600/50 gap-3 py-1 cursor-pointer`} onClick={() => handleIsOpen(index)}>
                                    <div className="flex flex-col flex-1 items-start justify-center py-3 px-10">
                                        <div className="flex flex-row justify-between  w-full">
                                            ...
                                            <div className="text-black font-normal text-lg md:text-xl flex flex-row">
                                                <span className={`overflow-hidden transition-all duration-[0.5s] ${isOpen === index ? 'rotate-45' : '' } `}><Icon icon="ic:round-plus" width="29" height="29" /></span>
                                                {/* <span className={`overflow-hidden transition-all duration-[0.5s] ${isOpen === index ? 'opacity-100' : 'opacity-0' } `}><Icon icon="charm:cross" width="29" height="29" /></span> */}
                                            </div>
                                        </div>
