    ...
    return (
        <>
            <div id="Contact-section" className=" flex flex-col w-full h-fit">
                ...
                <div className=" w-full flex-1 flex sm:flex-row flex-col">
                    {
                        customerSupportArray.map((details) => (
                            <div className="  h-full flex-1 flex-col flex sm:items-center items-start sm:pl-0 pl-2 sm:py-3 py-2">
                                <div className="flex sm:flex-col flex-row sm:items-center items-start gap-2">
