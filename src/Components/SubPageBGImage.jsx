...
const VisaBGImage = ({ setSearch, heading ,inputSubHeading , inputPlaceholder }) => {
    ...
    return (
        <>
            <div id="img" className="w-full  h-[11rem] bg-cover bg-center bg-no-repeat " style={{ backgroundImage: `url(${VisaBg})` }}>
                <div className="w-full  h-full   bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="w-full max-w-[1200px] h-full flex justify-center items-center flex-col py-4 md:py-4 gap-6 md:gap-0 md:flex-row md:justify-between md:px-4 px-0 ">
